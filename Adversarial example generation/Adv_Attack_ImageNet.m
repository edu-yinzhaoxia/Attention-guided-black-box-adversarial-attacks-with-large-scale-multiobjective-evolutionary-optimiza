...
% DimReduction --- 0 --- The manner of the reduction specified (0-5)
    ...
    methods
        ...
        function obj = Adv_Attack_ImageNet()
            ...
            switch DimReduction
                ...
                case 1  % Reduction with block-wise random selection
                     RegionIndex = Blockwise_random_selection(ImageSize);
